 ...
 **/
@Component
public class WmsAuthGatewayFilterFactory extends AbstractGatewayFilterFactory<Object> {

    private static final Logger logger = LoggerFactory.getLogger(WmsAuthGatewayFilterFactory.class);
    ...
    public GatewayFilter apply(Object config) {
        return (exchange, chain) -> {
            ...
            logger.info("express gateway filter factory host {}" ,host);
